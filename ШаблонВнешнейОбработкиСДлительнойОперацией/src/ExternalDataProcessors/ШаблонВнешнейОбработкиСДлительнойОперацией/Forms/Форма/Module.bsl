...
Процедура ЗаписатьРеквизитыИТабличныеЧасти(ПараметрыПроцедуры, Реквизиты = Неопределено, ТабличныеЧасти = Неопределено)
	...
	ОбработкаОбъект = РеквизитФормыВЗначение("Объект");	
	ОбработкаОбъект.ЗаписатьРеквизитыИТабличныеЧасти(ПараметрыПроцедуры, Реквизиты = Неопределено, ТабличныеЧасти = Неопределено);
...
Процедура ПрочитатьРеквизитыИТабличныеЧасти(РезультатВыполненияПроцедуры, Реквизиты = Неопределено, ТабличныеЧасти = Неопределено)
	...
	ОбработкаОбъект = РеквизитФормыВЗначение("Объект");	
	ОбработкаОбъект.ПрочитатьРеквизитыИТабличныеЧасти(РезультатВыполненияПроцедуры, Реквизиты = Неопределено, ТабличныеЧасти = Неопределено);
